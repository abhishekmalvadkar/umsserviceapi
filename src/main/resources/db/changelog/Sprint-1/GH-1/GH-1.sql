...
--changeset Abhishek Malvadkar:1-create-roles-table
CREATE TABLE roles (
...
--changeset Abhishek Malvadkar:2-insert-roles
...
--changeset Abhishek Malvadkar:7-create-option-source-table
...
--changeset Abhishek Malvadkar:8-insert-option-source-data
INSERT INTO option_source(id, mapping_name)
VALUES (1, 'urlStatusList');


--changeset Abhishek Malvadkar:9-create-header-config-table
...
--changeset Abhishek Malvadkar:10-insert-header-config-data
...
--changeset Abhishek Malvadkar:13-insert-url-status-data
